...
#define XDefineFunc_XMapComeTrue(name,com,type) const bool name##_##type##_##XMap(const void* LPrevValue, const void* LNextValue){return XPair_First(LPrevValue,type) com XPair_First(LNextValue,type);}
...
#define XDefineFunc_XMapComeTrueTwo(name,com,typeOne,typeTwo) const bool name##_##typeOne##_##typeTwo##_##XMap(const void* LPrevValue, const void* LNextValue){return XPair_First(LPrevValue,typeOne typeTwo) com XPair_First(LNextValue,typeOne typeTwo);}
