...
struct XVector* XVectorTwoMatrix_init(const size_t TypeSize, const size_t row,const size_t list,const void* initVal);
////开辟一个二维动态数组,初始化row行 list列
//struct XVector* XVectorTwo_init(const size_t TypeSize);
//拷贝复制一个二维数组
