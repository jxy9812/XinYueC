...
#define LWIP_IPV4               1
#define LWIP_IPV6               1  // 
#define LWIP_IGMP               0  // 禁用IGMP多播
#define LWIP_AUTOIP             0  // 禁用AutoIP
#define LWIP_DNS                1  // 启用DNS客户端

/* 内存管理配置 */
#define MEM_CUSTOM_ALLOCATOR    1
#define MEM_CUSTOM_MALLOC       XMemory_malloc
#define MEM_CUSTOM_FREE         XMemory_free
#define MEM_CUSTOM_CALLOC       XMemory_calloc
...
#define MEMP_NUM_NETBUF         4    // 新增：NetBuf数量
#define MEMP_NUM_NETCONN        4    // 新增：NetConn数量
...
/* API支持配置 */
#define LWIP_SOCKET             1      // 启用BSD Socket API
