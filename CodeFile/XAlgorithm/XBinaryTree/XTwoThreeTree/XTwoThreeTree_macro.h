...
//23树-设置父节点
#define XTTTree_SetParent(this_root,node) (*XBTree_GetTreeNode(this_root, XBTreeParent)=node)
//23树-设置节点,0是指向父节点
#define XTTTree_SetNode(this_root,nSel，node) (*XTTTree_Node(this_root,nSel)=node)
