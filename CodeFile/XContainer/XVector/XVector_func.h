...
// 向量尾部增加一个元素
void XVector_push_back(struct XVector* this_vector, void* LPValue);
// 向量中指向元素p前增加一个元素
void XVector_insert_front(struct XVector* this_vector, const void* p, const void* LPValue);
// 向量中指向元素p前增加n个相同的元素x
void XVector_insert_nfront(struct XVector* this_vector, const void* p, const int n, const void* LPValue);
