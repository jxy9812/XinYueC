...
void ListSortTest()
{
	XList* li = XList_new(sizeof(int),XEquality_int);
	int size = 10;
...
void ListTest()
{
	XList* list = XList_new(sizeof(int), XEquality_int);
...
{
	XList* li1 = XList_new(sizeof(int), XEquality_int);
	int num;
	...
	XList* li2 = XList_new(sizeof(int), XEquality_int);
