...
void XDataFrameComm_init(XDataFrameComm* comm, XIODevice* io)
{
	...
	XContainerSetCompare(comm->m_periodicSendList, uintptr_t_compare);
	...
	//XObject_connect_1(io,XSignal(XIODevice_readyRead_signal),comm,XObject_poll_base,XConnectionType_Auto);
}
