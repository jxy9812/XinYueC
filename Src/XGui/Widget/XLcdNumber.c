...
static const char* xlcd_segments(char ch)
{
    static const char segments[30][8] = {
        /* 段编号与 xlcd_drawSegment 的 case 一致：
           0=a(顶) 1=b(右上) 2=c(右下) 3=d(底) 4=e(左下) 5=f(左上) 6=g(中) */
        { 0, 1, 2, 3, 4, 5, 99, 0},             /* 0    0 / O        */
        { 1, 2, 99, 0, 0, 0, 0, 0},             /* 1    1            */
        { 0, 1, 3, 4, 6, 99, 0, 0},             /* 2    2            */
        { 0, 1, 2, 3, 6, 99, 0, 0},             /* 3    3            */
        { 1, 2, 5, 6, 99, 0, 0, 0},             /* 4    4            */
        { 0, 2, 3, 5, 6, 99, 0, 0},             /* 5    5 / S        */
        { 0, 2, 3, 4, 5, 6, 99, 0},             /* 6    6            */
        { 0, 1, 2, 99, 0, 0, 0, 0},             /* 7    7            */
        { 0, 1, 2, 3, 4, 5, 6, 99},             /* 8    8            */
        { 0, 1, 2, 3, 5, 6, 99, 0},             /* 9    9 / g        */
        { 6, 99, 0, 0, 0, 0, 0, 0},             /* 10   -            */
        { 7, 99, 0, 0, 0, 0, 0, 0},             /* 11   .            */
        { 0, 1, 2, 4, 5, 6, 99, 0},             /* 12   A            */
        { 2, 3, 4, 5, 6, 99, 0, 0},             /* 13   B            */
        { 0, 3, 4, 5, 99, 0, 0, 0},             /* 14   C            */
        { 1, 2, 3, 4, 6, 99, 0, 0},             /* 15   D            */
        { 0, 3, 4, 5, 6, 99, 0, 0},             /* 16   E            */
        { 0, 4, 5, 6, 99, 0, 0, 0},             /* 17   F            */
        { 2, 4, 5, 6, 99, 0, 0, 0},             /* 18   h            */
        { 1, 2, 4, 5, 6, 99, 0, 0},             /* 19   H            */
        { 3, 4, 5, 99, 0, 0, 0, 0},             /* 20   L            */
        { 2, 3, 4, 6, 99, 0, 0, 0},             /* 21   o            */
