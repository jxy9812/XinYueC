...
#endif
/** @brief X边框set边框形状2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_setFrameShape_2(XFrame* self);
/** @brief X边框frame形状2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_frameShape_2(XFrame* self);
/** @brief X边框set边框阴影2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_setFrameShadow_2(XFrame* self);
/** @brief X边框frame阴影2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_frameShadow_2(XFrame* self);
/** @brief X边框set行宽2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_setLineWidth_2(XFrame* self);
/** @brief X边框line宽2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_lineWidth_2(XFrame* self);
/** @brief X边框set中间行宽2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_setMidLineWidth_2(XFrame* self);
/** @brief X边框mid行宽2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_midLineWidth_2(XFrame* self);
/** @brief X边框frame宽2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_frameWidth_2(XFrame* self);
/** @brief X边框frame矩形2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_frameRect_2(XFrame* self);
/** @brief X边框set边框矩形2（对标 Qt 同名接口）。
 * @param self 目标控件指针。
 * @return 无返回值。
 */
void XFrame_setFrameRect_2(XFrame* self);
#endif /* XFRAME_H */
