...
#define XTimerTimeWheel_getTimeout XTimerBase_getTimeout
#define XTimerTimeWheel_getInterval XTimerBase_getInterval
#define XTimerTimeWheel_getGroup XTimerBase_getTimerId
