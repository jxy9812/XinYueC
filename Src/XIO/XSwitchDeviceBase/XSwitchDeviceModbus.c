...
//		//虚函数表初始化
//#if VTABLE_ISSTACK
//		XVTABLE_STACK_INIT_DEFAULT_SIZE(XSWITCHDEVICEMODBUS_VTABLE_SIZE)
//#else
...
//	if (!XIODevice_isOpen(sw))
//		return;
//	XModbusDigitalSwitch_XSwitchDeviceModbusClose(sw->m_ds,sw, ((XIODevice*)sw)->m_openMode,sw->m_portNum);
//	((XIODevice*)sw)->m_openMode = XIODevice_NotOpen;
//}
//
//void VXIODevice_poll(XSwitchDeviceModbus* sw)
//{
//	XSwitchDeviceBase* base = sw;
//	if (base->m_class.m_openMode & XIODevice_ReadOnly)
//	{
//		//读取当前电平状态
//		bool trigger;
...
//			{
//				XObject_postEvent(sw, XEventFunc_create(base->m_stateChangeCallback, sw, NULL), XEVENT_PRIORITY_NORMAL);
//			}
//		}
//	}
//}
