...
#define XTUI_VIM_ON XCONSOLE_SHELL_VIM_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_MULTIBUFFER_ON) && !defined(XTUI_VIM_MULTIBUFFER_ON)
#define XTUI_VIM_MULTIBUFFER_ON XCONSOLE_SHELL_VIM_MULTIBUFFER_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_MAX_BUFFERS) && !defined(XTUI_VIM_MAX_BUFFERS)
#define XTUI_VIM_MAX_BUFFERS XCONSOLE_SHELL_VIM_MAX_BUFFERS
#endif
#if defined(XCONSOLE_SHELL_VIM_EX_ON) && !defined(XTUI_VIM_EX_ON)
#define XTUI_VIM_EX_ON XCONSOLE_SHELL_VIM_EX_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_HISTORY_ON) && !defined(XTUI_VIM_HISTORY_ON)
#define XTUI_VIM_HISTORY_ON XCONSOLE_SHELL_VIM_HISTORY_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_HISTORY_MAX) && !defined(XTUI_VIM_HISTORY_MAX)
#define XTUI_VIM_HISTORY_MAX XCONSOLE_SHELL_VIM_HISTORY_MAX
#endif
#if defined(XCONSOLE_SHELL_VIM_SUBSTITUTE_ON) && !defined(XTUI_VIM_SUBSTITUTE_ON)
#define XTUI_VIM_SUBSTITUTE_ON XCONSOLE_SHELL_VIM_SUBSTITUTE_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON) && !defined(XTUI_VIM_SUBSTITUTE_CONFIRM_ON)
#define XTUI_VIM_SUBSTITUTE_CONFIRM_ON XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_SEARCH_ON) && !defined(XTUI_VIM_SEARCH_ON)
#define XTUI_VIM_SEARCH_ON XCONSOLE_SHELL_VIM_SEARCH_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_YANK_PASTE_ON) && !defined(XTUI_VIM_YANK_PASTE_ON)
#define XTUI_VIM_YANK_PASTE_ON XCONSOLE_SHELL_VIM_YANK_PASTE_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_REGISTER_ON) && !defined(XTUI_VIM_REGISTER_ON)
#define XTUI_VIM_REGISTER_ON XCONSOLE_SHELL_VIM_REGISTER_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_UNDO_REDO_ON) && !defined(XTUI_VIM_UNDO_REDO_ON)
#define XTUI_VIM_UNDO_REDO_ON XCONSOLE_SHELL_VIM_UNDO_REDO_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_REPLACE_ON) && !defined(XTUI_VIM_REPLACE_ON)
#define XTUI_VIM_REPLACE_ON XCONSOLE_SHELL_VIM_REPLACE_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_MACRO_ON) && !defined(XTUI_VIM_MACRO_ON)
#define XTUI_VIM_MACRO_ON XCONSOLE_SHELL_VIM_MACRO_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_MARK_ON) && !defined(XTUI_VIM_MARK_ON)
#define XTUI_VIM_MARK_ON XCONSOLE_SHELL_VIM_MARK_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_JUMPLIST_ON) && !defined(XTUI_VIM_JUMPLIST_ON)
#define XTUI_VIM_JUMPLIST_ON XCONSOLE_SHELL_VIM_JUMPLIST_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_JUMPLIST_MAX) && !defined(XTUI_VIM_JUMPLIST_MAX)
#define XTUI_VIM_JUMPLIST_MAX XCONSOLE_SHELL_VIM_JUMPLIST_MAX
#endif
#if defined(XCONSOLE_SHELL_VIM_VISUAL_ON) && !defined(XTUI_VIM_VISUAL_ON)
#define XTUI_VIM_VISUAL_ON XCONSOLE_SHELL_VIM_VISUAL_ON
#endif
#if defined(XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON) && !defined(XTUI_VIM_ADVANCED_MOTION_ON)
#define XTUI_VIM_ADVANCED_MOTION_ON XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON
#endif
#include "XTuiConfig.h"

#ifndef XCONSOLE_SHELL_VIM_ON
#define XCONSOLE_SHELL_VIM_ON XTUI_VIM_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_MULTIBUFFER_ON
#define XCONSOLE_SHELL_VIM_MULTIBUFFER_ON XTUI_VIM_MULTIBUFFER_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_MAX_BUFFERS
#define XCONSOLE_SHELL_VIM_MAX_BUFFERS XTUI_VIM_MAX_BUFFERS
#endif
#ifndef XCONSOLE_SHELL_VIM_EX_ON
#define XCONSOLE_SHELL_VIM_EX_ON XTUI_VIM_EX_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_HISTORY_ON
#define XCONSOLE_SHELL_VIM_HISTORY_ON XTUI_VIM_HISTORY_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_HISTORY_MAX
#define XCONSOLE_SHELL_VIM_HISTORY_MAX XTUI_VIM_HISTORY_MAX
#endif
#ifndef XCONSOLE_SHELL_VIM_SUBSTITUTE_ON
#define XCONSOLE_SHELL_VIM_SUBSTITUTE_ON XTUI_VIM_SUBSTITUTE_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON
#define XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON XTUI_VIM_SUBSTITUTE_CONFIRM_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_SEARCH_ON
#define XCONSOLE_SHELL_VIM_SEARCH_ON XTUI_VIM_SEARCH_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_YANK_PASTE_ON
#define XCONSOLE_SHELL_VIM_YANK_PASTE_ON XTUI_VIM_YANK_PASTE_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_REGISTER_ON
#define XCONSOLE_SHELL_VIM_REGISTER_ON XTUI_VIM_REGISTER_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_UNDO_REDO_ON
#define XCONSOLE_SHELL_VIM_UNDO_REDO_ON XTUI_VIM_UNDO_REDO_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_REPLACE_ON
#define XCONSOLE_SHELL_VIM_REPLACE_ON XTUI_VIM_REPLACE_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_MACRO_ON
#define XCONSOLE_SHELL_VIM_MACRO_ON XTUI_VIM_MACRO_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_MARK_ON
#define XCONSOLE_SHELL_VIM_MARK_ON XTUI_VIM_MARK_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_JUMPLIST_ON
#define XCONSOLE_SHELL_VIM_JUMPLIST_ON XTUI_VIM_JUMPLIST_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_JUMPLIST_MAX
#define XCONSOLE_SHELL_VIM_JUMPLIST_MAX XTUI_VIM_JUMPLIST_MAX
#endif
#ifndef XCONSOLE_SHELL_VIM_VISUAL_ON
#define XCONSOLE_SHELL_VIM_VISUAL_ON XTUI_VIM_VISUAL_ON
#endif
#ifndef XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON
#define XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON XTUI_VIM_ADVANCED_MOTION_ON
#endif
...
#define XCONSOLE_SHELL_CONSOLE_ON 1
#endif
...
#ifndef XCONSOLE_SHELL_XSSH_MAX_AUTH_ATTEMPTS
#define XCONSOLE_SHELL_XSSH_MAX_AUTH_ATTEMPTS 3
#endif
...
#define XCONSOLE_SHELL_COMPLETION_ON 1
#endif
...
#undef XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON
#define XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON 0
...
#if defined(XCONSOLE_SHELL_XSSHSERVER_BACKEND_DEFAULT_ON) && \
    (!XCONSOLE_SHELL_XTCPSERVER_BACKEND_ON || !XCONSOLE_SHELL_LOGIN_ON || \
     !XCONSOLE_SHELL_AUTH_ON)
#undef XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON
#define XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON 0
#endif
#ifdef XCONSOLE_SHELL_XSSHSERVER_BACKEND_DEFAULT_ON
#undef XCONSOLE_SHELL_XSSHSERVER_BACKEND_DEFAULT_ON
#endif

#if XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON && !XCONSOLE_SHELL_XTCPSERVER_BACKEND_ON
#error "XConsoleShell: SSH server requires XTcpServer backend"
#endif
#if XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON && !XCONSOLE_SHELL_LOGIN_ON
#error "XConsoleShell: SSH server requires login/account database"
#endif
#if XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON && !XCONSOLE_SHELL_AUTH_ON
#error "XConsoleShell: SSH server requires AUTH_ON"
#endif
#if XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON && XCONSOLE_SHELL_XSSH_MAX_AUTH_ATTEMPTS < 1
#error "XConsoleShell: XSSH_MAX_AUTH_ATTEMPTS must be positive"
#endif
#if XCONSOLE_SHELL_XSSHSERVER_BACKEND_ON && XCONSOLE_SHELL_XSSH_MAX_AUTH_ATTEMPTS > 255
#error "XConsoleShell: XSSH_MAX_AUTH_ATTEMPTS must fit in uint8_t"
#endif
...
#if !XCONSOLE_SHELL_EDITOR_ON || !XCONSOLE_SHELL_EDITOR_TUI_ON
/* Shell 不使用 XTuiVim 时，把 XTuiVim 全部子功能裁剪到 0；
   总开关 XTUI_VIM_ON 仍可单独关闭整个控件。 */
#undef XTUI_VIM_MULTIBUFFER_ON
#define XTUI_VIM_MULTIBUFFER_ON 0
#undef XTUI_VIM_EX_ON
#define XTUI_VIM_EX_ON 0
...
#undef XTUI_VIM_SEARCH_ON
#define XTUI_VIM_SEARCH_ON 0
#undef XTUI_VIM_YANK_PASTE_ON
#define XTUI_VIM_YANK_PASTE_ON 0
#undef XTUI_VIM_REGISTER_ON
#define XTUI_VIM_REGISTER_ON 0
#undef XTUI_VIM_UNDO_REDO_ON
#define XTUI_VIM_UNDO_REDO_ON 0
#undef XTUI_VIM_REPLACE_ON
#define XTUI_VIM_REPLACE_ON 0
#undef XTUI_VIM_MACRO_ON
#define XTUI_VIM_MACRO_ON 0
#undef XTUI_VIM_MARK_ON
#define XTUI_VIM_MARK_ON 0
#undef XTUI_VIM_JUMPLIST_ON
#define XTUI_VIM_JUMPLIST_ON 0
#undef XTUI_VIM_VISUAL_ON
#define XTUI_VIM_VISUAL_ON 0
#undef XTUI_VIM_ADVANCED_MOTION_ON
#define XTUI_VIM_ADVANCED_MOTION_ON 0
#endif

/* 对外暴露的 Shell 别名始终反映依赖裁剪后的实际 XTuiVim 值。 */
#undef XCONSOLE_SHELL_VIM_ON
#define XCONSOLE_SHELL_VIM_ON XTUI_VIM_ON
#undef XCONSOLE_SHELL_VIM_MULTIBUFFER_ON
#define XCONSOLE_SHELL_VIM_MULTIBUFFER_ON XTUI_VIM_MULTIBUFFER_ON
#undef XCONSOLE_SHELL_VIM_MAX_BUFFERS
#define XCONSOLE_SHELL_VIM_MAX_BUFFERS XTUI_VIM_MAX_BUFFERS
#undef XCONSOLE_SHELL_VIM_EX_ON
#define XCONSOLE_SHELL_VIM_EX_ON XTUI_VIM_EX_ON
#undef XCONSOLE_SHELL_VIM_SUBSTITUTE_ON
#define XCONSOLE_SHELL_VIM_SUBSTITUTE_ON XTUI_VIM_SUBSTITUTE_ON
#undef XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON
#define XCONSOLE_SHELL_VIM_SUBSTITUTE_CONFIRM_ON XTUI_VIM_SUBSTITUTE_CONFIRM_ON
#undef XCONSOLE_SHELL_VIM_SEARCH_ON
#define XCONSOLE_SHELL_VIM_SEARCH_ON XTUI_VIM_SEARCH_ON
#undef XCONSOLE_SHELL_VIM_YANK_PASTE_ON
#define XCONSOLE_SHELL_VIM_YANK_PASTE_ON XTUI_VIM_YANK_PASTE_ON
#undef XCONSOLE_SHELL_VIM_REGISTER_ON
#define XCONSOLE_SHELL_VIM_REGISTER_ON XTUI_VIM_REGISTER_ON
#undef XCONSOLE_SHELL_VIM_UNDO_REDO_ON
#define XCONSOLE_SHELL_VIM_UNDO_REDO_ON XTUI_VIM_UNDO_REDO_ON
#undef XCONSOLE_SHELL_VIM_REPLACE_ON
#define XCONSOLE_SHELL_VIM_REPLACE_ON XTUI_VIM_REPLACE_ON
#undef XCONSOLE_SHELL_VIM_MACRO_ON
#define XCONSOLE_SHELL_VIM_MACRO_ON XTUI_VIM_MACRO_ON
#undef XCONSOLE_SHELL_VIM_MARK_ON
#define XCONSOLE_SHELL_VIM_MARK_ON XTUI_VIM_MARK_ON
#undef XCONSOLE_SHELL_VIM_JUMPLIST_ON
#define XCONSOLE_SHELL_VIM_JUMPLIST_ON XTUI_VIM_JUMPLIST_ON
#undef XCONSOLE_SHELL_VIM_JUMPLIST_MAX
#define XCONSOLE_SHELL_VIM_JUMPLIST_MAX XTUI_VIM_JUMPLIST_MAX
#undef XCONSOLE_SHELL_VIM_VISUAL_ON
#define XCONSOLE_SHELL_VIM_VISUAL_ON XTUI_VIM_VISUAL_ON
#undef XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON
#define XCONSOLE_SHELL_VIM_ADVANCED_MOTION_ON XTUI_VIM_ADVANCED_MOTION_ON
