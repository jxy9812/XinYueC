...
{
	XVector_push_front(this_stringVector,&string);
}
...
{
	XVector_push_back(this_stringVector, &string);
}
...
{
	return XVector_At(this_stringVector,index,XString*);
}

XString* XStringVector_front(const XStringVector* this_stringVector)
{
	return XVector_Front(this_stringVector,XString*);
}

XString* XStringVector_back(const XStringVector* this_stringVector)
{
	return XVector_Back(this_stringVector, XString*);
}
