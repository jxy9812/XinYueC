/**
 * \file psa-crypto/check_config.h
 *
 ...
 * (via mbedtls/private/crypto_build_info.h). Do not include it directly in a
 ...
 * in <mbedtls/private/crypto_adjust_config_support.h> */
