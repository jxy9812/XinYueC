...
typedef struct mbedtls_hmac_drbg_context {
    /* Working state. K remains explicit so that the XCryptographic HMAC
     * backend can execute the same SP 800-90A state machine. */
    mbedtls_md_context_t MBEDTLS_PRIVATE(md_ctx);                    /*!< Digest metadata/context */
    unsigned char MBEDTLS_PRIVATE(K)[MBEDTLS_MD_MAX_SIZE];           /*!< K in the specification  */
