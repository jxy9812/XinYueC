...
static void XESP8266Wifi_TCP_Client_Test(XMenu* root)
{
    ...
    XObject_connect_1(wifi,XSignal(XESP8266Wifi_error_signal),NULL, errorSlot,XConnectionType_Auto);
    XObject_connect_1(wifi, XSignal(XESP8266Wifi_readyRead_signal), wifi, dataReceived_signal, XConnectionType_Queued);
